...
from AlexNet2D_ensenble import alexnet_ensemble
...
def main(options):
    ...
    TESTING_PATH = '/media/ailab/Backup Plus/ADNI/data/test_3classes.txt'
    ...
    # Initial the model
    model = alexnet_ensemble(pretrained=False)
